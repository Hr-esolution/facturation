        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Créer une nouvelle facture</h4>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('numero_facture') is-invalid @enderror" 
                                           id="numero_facture" name="numero_facture" value="{{ old('numero_facture') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_emission') is-invalid @enderror" 
                                           id="date_emission" name="date_emission" value="{{ old('date_emission', date('Y-m-d')) }}" required>
                                    @error('date_emission')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_echeance') is-invalid @enderror" 
                                           id="date_echeance" name="date_echeance" value="{{ old('date_echeance') }}" required>
                                    @error('date_echeance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('pays_client') is-invalid @enderror" 
                                        ...
                                        <option value="FR" {{ old('pays_client') == 'FR' ? 'selected' : '' }}>France</option>
                                        <option value="MA" {{ old('pays_client') == 'MA' ? 'selected' : '' }}>Maroc</option>
                                        <option value="EU" {{ old('pays_client') == 'EU' ? 'selected' : '' }}>Union Européenne</option>
                                        <option value="CA" {{ old('pays_client') == 'CA' ? 'selected' : '' }}>Canada</option>
                                        <option value="US" {{ old('pays_client') == 'US' ? 'selected' : '' }}>États-Unis</option>
                                    </select>
                                    @error('pays_client')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div id="produits-container">
                                <div class="produit-row mb-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="produits[0][designation]" placeholder="Désignation" required>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" step="0.01" class="form-control" name="produits[0][quantite]" placeholder="Quantité" required>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" step="0.01" class="form-control" name="produits[0][prix_unitaire]" placeholder="Prix unitaire" required>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" step="0.01" class="form-control" name="produits[0][taux_tva]" placeholder="TVA %" value="20" required>
                                        </div>
                                        <div class="col-md-2">
